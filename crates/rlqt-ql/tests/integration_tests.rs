...
//! - crates/rlqt-cli/tests/fixtures/rabbit@fixture1.log
//! - crates/rlqt-cli/tests/fixtures/rabbit@fixture2.log
//! - crates/rlqt-cli/tests/fixtures/rabbit@fixture3.log
//! - crates/rlqt-cli/tests/fixtures/rabbit@fixture4.log

use rlqt_ql::{parse, parse_and_compile};
...
fn test_invalid_severity_fails() {
    ...
    assert!(parsed.is_ok());
    let compiled = rlqt_ql::compile(&parsed.unwrap());
