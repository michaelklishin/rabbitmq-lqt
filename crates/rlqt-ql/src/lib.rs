...
//!
//! ```
//! let compiled = rlqt_ql::parse_and_compile(r#"{severity="error"} | limit 100"#).unwrap();
//! ```
//!
//! # Builder API
//!
...
//!
//! ```
//! use rlqt_ql::builder::QueryBuilder;
//! use rlqt_ql::ast::{Field, SortDirection};
//!
...
// Re-export everything from rlqt-ql-core
pub use rlqt_ql_core::PresetName;
pub use rlqt_ql_core::ast;
pub use rlqt_ql_core::autocomplete;
pub use rlqt_ql_core::presets;
pub use rlqt_ql_core::{Diagnostic, ParseError, Span};
pub use rlqt_ql_core::{
    Duration, DurationUnit, Field, FilterExpr, LabelMatcher, MatchOp, PipelineStage, Query,
    Selector, SortDirection, SortSpec, Value,
};
pub use rlqt_ql_core::{parse, parse_filter_only};
...
/// Parses a query string and returns a QueryContext for use with rlqt-lib.
pub fn to_query_context(input: &str) -> Result<rlqt_lib::QueryContext> {
